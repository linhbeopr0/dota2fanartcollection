...
public class FullScreenActivity extends Activity {
    ...
    private ImageView mImgFullScreenView;
...
//		mLink = refineTo1280(mLink);
        ...
        mImgFullScreenView = (ImageView) findViewById(R.id.imgFullscreen);
    ...
    private void displayFullScreenImage(int id) {
...
//		mImgFullScreenView.setImageUrl(link, mImgLoader);
        mImgFullScreenView.setImageResource(id);
    }
